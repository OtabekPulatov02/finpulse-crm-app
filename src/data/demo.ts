...
export type TaskStatus = "Новая" | "В работе" | "Ожидание" | "Выполнена" | "Отменена";
export type Priority = "Низкий" | "Средний" | "Высокий" | "Критический";

export const statusTone: Record<TaskStatus, Tone> = {
  "Новая": "purple", "В работе": "blue", "Ожидание": "yellow", "Выполнена": "green", "Отменена": "gray",
};
...
export interface Task {
  id: number; title: string; client: string; assignee: string;
  status: TaskStatus; priority: Priority; due: string; fromBot?: boolean;
}

export const tasks: Task[] = [
  { id: 1247, title: "Подготовить декларацию по НДС за II квартал", client: "ООО «ТехноСфера»", assignee: "Елена Крылова", status: "В работе", priority: "Высокий", due: "25.07", fromBot: true },
  { id: 1252, title: "Ответ на требование ИФНС № 14-08/2214", client: "ООО «СтройГарант»", assignee: "Ольга Никитина", status: "Новая", priority: "Критический", due: "10.07" },
  { id: 1244, title: "Начислить зарплату за июнь", client: "АО «ВекторПлюс»", assignee: "Анна Смирнова", status: "В работе", priority: "Средний", due: "06.07" },
  { id: 1249, title: "Акт сверки с поставщиком «ФармОпт»", client: "ООО «МедФарм»", assignee: "Дмитрий Орлов", status: "Ожидание", priority: "Средний", due: "15.07", fromBot: true },
  { id: 1253, title: "Кадровые документы для нового сотрудника", client: "ООО «Логистик Групп»", assignee: "Игорь Васильев", status: "Новая", priority: "Низкий", due: "14.07", fromBot: true },
  { id: 1240, title: "6-НДФЛ за полугодие", client: "ООО «МедФарм»", assignee: "Дмитрий Орлов", status: "Выполнена", priority: "Высокий", due: "03.07" },
  { id: 1255, title: "Оплатить аренду офиса (12 000 000 сум)", client: "ООО «ТехноСфера»", assignee: "Елена Крылова", status: "Новая", priority: "Средний", due: "15.07" },
  { id: 1218, title: "Переход на электронный документооборот", client: "ИП Соколова А. В.", assignee: "Дмитрий Орлов", status: "Отменена", priority: "Низкий", due: "—" },
];
